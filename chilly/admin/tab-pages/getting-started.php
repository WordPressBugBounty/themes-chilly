...
<div id="getting_started" class="chilly-tab-pane active">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="chilly-info-title text-center"><?php echo esc_html__('About the Chilly theme','chilly'); ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="chilly-tab-pane-half chilly-tab-pane-first-half">
					<a href="<?php echo esc_url('https://wordpress.org/support/theme/chilly/'); ?>" target="_blank"  class="info-block"><div class="dashicons dashicons-sos info-icon"></div>
					<p class="info-text"><?php echo esc_html__('Theme Support','chilly'); ?></p></a>
				</div>
			</div>
			<div class="col-md-6">
				<div class="chilly-tab-pane-half chilly-tab-pane-first-half">
			...
			<div class="col-md-6">
				<div class="chilly-tab-pane-half chilly-tab-pane-first-half">
					<a href="<?php echo esc_url('https://spicethemes.com/chilly-changelog/'); ?>" target="_blank"  class="info-block"><div class="dashicons dashicons-portfolio info-icon"></div>
					<p class="info-text"><?php echo esc_html__('Changelog','chilly'); ?></p></a>
				</div>
			</div>
		</div>
	</div>
